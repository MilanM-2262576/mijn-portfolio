...
export default function OverMijPage({ onBekijkProjecten }) {
  return (
    <section className="relative flex flex-col items-center justify-center min-h-screen w-full bg-black overflow-hidden">
      <FloatingIcons />
      <motion.div
        className="relative z-10 bg-white/90 rounded-xl shadow-2xl p-8 max-w-2xl w-full flex flex-col items-center"
      ...
      >
        <img
          src="/globe.svg"
          alt="Profiel"
          className="w-32 h-32 rounded-full border-4 border-blue-300 shadow mb-6"
        />
        ...
        <div className="flex gap-4 mt-2">
          ...
          <button
            className="bg-white border border-blue-600 text-blue-700 px-4 py-2 rounded shadow hover:bg-blue-50 transition"
